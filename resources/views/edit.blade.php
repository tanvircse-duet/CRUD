        ...
        <div>
            <form action="{{ route('update',$ourpost->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="name" value="{{$ourpost->Name}}" id="name" placeholder="Enter name">
                    @error('name')
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" name="description" value="{{$ourpost->Description}}"  id="description" rows="3" placeholder="Enter description">
                </div>
                @error('description')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                <div class="mb-3">
                    ...
                    <input type="file" class="form-control" value="{{$ourpost->Image}}"  name="image" id="image">
                </div>
                @error('image')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
